...
public class ExceptionAdvice {
    ...
    public Object serviceException(ServiceException e) {
        ...
        return R.error(e.getResultCode(), coderMessage);
    }
    ...
    public Object hibernateValidatorException(BindException e) {
        ...
        // 响应
        return R.error(ResultCode.ILLEGAL_PARAM, firstFieldError.getDefaultMessage());
    }
    ...
    public Object exception(Exception e) {
        ...
        return R.error(ResultCode.SERVER_ERROR, coderMessage);
    }
}